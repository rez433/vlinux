...
#
# 89a689b0a5565b2100dd23604ac8f91d
# vlinux
# bash1
# v1
# rere20
...
# v4.0.0 (2019-03-05)
#
# Generated 2021-09-19 21:30:18 by dbwebb lab-utility v4.0.0 (2019-03-05).
...
ANSWER=$(cd apache2/mods-available && ls -d a*.conf);
...
ANSWER=$(mkdir -p backup && mkdir -p backup/conf && cp apache2/mods-available/*.conf backup/conf/ && ls -S backup/conf/);
...
ANSWER=$(find apache2/ -empty -type f);
...
ANSWER=$(find apache2/ -maxdepth 1 -type d -name "*conf*" | sort);
